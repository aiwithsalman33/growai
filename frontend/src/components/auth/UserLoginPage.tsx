...
export const UserLoginPage: React.FC = () => {
  ...
  return (
    <AuthShell
      ...
      subtitle="Manage your Google Business Profile, reviews, and scheduled posts"
      footer={
        <div className="flex flex-col gap-2.5">
          <div>
            New to Partner.ai?{' '}
            <AuthLink onClick={() => navigate('/signup/user')}>Create an account</AuthLink>
          </div>
          <div className="text-[11px]">
            Managing profiles for clients?{' '}
            <AuthLink onClick={() => navigate('/login/agency')}>Agency sign in</AuthLink>
          </div>
        </div>
      }
    >
